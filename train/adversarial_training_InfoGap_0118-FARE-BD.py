...
parser.add_argument('--shell_script_path', type=str, default="/home/aailab/kwakjs/InfoGap/RobustVLM/train/run_infogap_CA.sh", help='Path to the executed shell script to save.') # 새 인자 추가
...
def train_one_epoch(
    ...
    for i, (data, targets) in enumerate(dataloader):
        ...
        model.eval()
        # Freeze discriminator parts for PGD attack generation
        # Keep classifier trainable, freeze other parts
        ...
        if step_total % args.log_freq == 0:
            ...
            plt.hist(wq_cpu, bins=50, range=(0, 5), density=True, alpha=0.75)
