...
class Mine(nn.Module):
    ...
    def forward(self, x, y):
        ...
        mi_estimate =  - second_term * args.second_term_coeff
        # intermediate 값도 반환
...
def main():
    ...
    optimizer_d = torch.optim.Adam(discriminator.parameters(), lr=args.disc_lr_coeff * args.lr, betas=(0, 0.999), weight_decay=args.disc_wd_coeff*args.wd)
